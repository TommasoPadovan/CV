...
Strong knowledge in \textit{procedural}, \textit{object-oriented}, \textit{concurrent}, \textit{functional} and \textit{actor-based} programming paradigms.
...
\begin{itemize}[noitemsep,nolistsep]
	...
	\item Good knowledge of \textbf{Google Tango}\footnotemark[6] framework for augmented reality in mobile devices.
