...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2016-2017}
		{Developer at "Vision Lab Apps srl"\footnotemarkA[3]}	{Part-time Job}
		{Android + back-end of streaming application for smartphones and glasses.}
	\twentyitem{2016}
		{Developer at "Vic World Wide"\footnotemarkA[4]}	{Stage}
		{Prototype app for "world 3D reconstruction" using Google-Tango framework on mobile devices.}
	\twentyitem{2015-2016}
		{Developer at "EasyApp srl"\footnotemarkA[5]}	{Freelance Job}
...
\begin{itemize}[noitemsep,nolistsep]
	...
	\item Good knowledge of \textbf{Google Tango}\footnotemarkA[6] framework for augmented reality.
...
\footnotetextA[5]{\url{http://www.easyappsrl.it}}
